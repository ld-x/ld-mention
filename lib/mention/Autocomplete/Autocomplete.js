  ...
  _createClass(_default, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (prevProps.searchValue !== this.props.searchValue) {
        ...
        this.handleUpdateTimeout = setTimeout(function () {
          _this2.findUsers();
        }, 300);
      }
    }
    ...
    value: function findUsers() {
      ...
      if (mentionUsersAsync !== undefined) {
        ...
        mentionUsersAsync(searchValue).then(function (result) {
          _this3.setState({ foundUsers: result.mentionUsers });
        });
      } else {
      ...
      return foundUsers.map(function (item, i) {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            MentionItem,
            { className: 'ld-mention-item' },
            _react2.default.createElement(Avatar, { className: 'ld-mention-avatar', src: avatarSrc }),
            _react2.default.createElement(
              MentionName,
              { className: 'ld-mention-name', key: name, onClick: function onClick() {
                  return _this4.selectAutoComplete(item);
                } },
              name
            )
          )
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        Search,
        { className: 'ld-mention-autocomplete' },
        _react2.default.createElement(
          Menu,
          { style: menuStyle, className: 'ld-mention-menu' },
          _react2.default.createElement(
            List,
            { className: 'ld-mention-menu-list' },
            this.renderUsers()
          )
        )
      );
