...
var _default = function (_Component) {
  ...
  _createClass(_default, [{
    ...
    value: function setMention(user) {
      ...
      var updatedState = _draftJs.Modifier.replaceText(editorState.getCurrentContent(), targetRange, user.name, editorState.getCurrentInlineStyle(), entityKey);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        MentionListWrapper,
        { style: menuStyle, className: 'ld-mention-wrapper' },
